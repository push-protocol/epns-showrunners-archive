...
import CompoundLiquidationChannel from '../../../showrunners-sdk/compoundLiquidationChannel';
...
export default (app: Router) => {
  app.use('/showrunners-sdk/compound', route);
  ...
  route.post(
    ...
    async (req: Request, res: Response, next: NextFunction) => {
      ...
      Logger.debug('Calling /showrunners-sdk/compoundliquidation/send_message endpoint with body: %o', req.body )
      try {
  ...
  route.post(
    ...
    async (req: Request, res: Response, next: NextFunction) => {
      ...
      const Logger = Container.get('logger');
      Logger.debug('Calling /showrunners-sdk/compoundliquidation/check_liquidity endpoint with body: %o', req.body )
      try {
        const compoundLiquidation = Container.get(CompoundLiquidationChannel);
  ...
  route.post(
    ...
    async (req: Request, res: Response, next: NextFunction) => {
      const { address, network } = req.body;
      const Logger = Container.get('logger');
      Logger.debug('Calling /showrunners-sdk/compoundliquidation/check_assets endpoint with body: %o', req.body )
      try {
        const compoundLiquidation = Container.get(CompoundLiquidationChannel);
  ...
  route.post(
    ...
    async (req: Request, res: Response, next: NextFunction) => {
      ...
      const Logger = Container.get('logger');
      Logger.debug('Calling /showrunners-sdk/compoundliquidation/total_users endpoint with body: %o', req.body )
      try {
        const compoundLiquidation = Container.get(CompoundLiquidationChannel);
